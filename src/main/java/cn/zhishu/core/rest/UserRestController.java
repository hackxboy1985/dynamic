...
public class UserRestController {
    ...
    public Boolean copyUser(@PathVariable String username, @RequestParam String as, @RequestParam String ds) {
        log.info("as:{}", as);
        return userService.copyData2MainByUsername(username, as,ds);
    }
